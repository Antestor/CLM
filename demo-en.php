        ...
        <input id="redirect_url" type="hidden" name="redirect_url" value="https://www.clmforex.com/demo-account-thank-you"; />
                            ...
                            <div class="col-md-6" style="padding-right: 5px;">                              
                                <div class="form-group">
                                    ...
                                    <input id="lead-first-name" type="text" name="lead-first-name" class="form-control" placeholder="First name*" required="required" data-error="Firstname is required.">
                            ...
                            <div class="col-md-6" style="padding-left: 5px;">
                                <div class="form-group">
                                    ...
                                    <input id="lead-last-name" type="text" name="lead-last-name" class="form-control" placeholder="Last name*" required="required" data-error="Lastname is required.">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="lead-email" type="email" name="lead-email" class="form-control" placeholder="Email address*" required="required" data-error="Valid email is required." value="<?php if (isset($email)) echo $emailError ?>">
                                   <!--  <span class="error"><?php if (isset($emailError)) echo $emailError ?></span>  -->
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
...
/* input[type="checkbox"]:not(:disabled)+span.tyc:hover:before { text-shadow: 0 1px 2px #77F; } */
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label style="position:relative; padding-left:27px; display:block; color: #515151; display: block; font-size: 11px; font-family: avenir-regular; font-weight: 500;"><input class="abc" type="checkbox" required="required"><span class="tyc" id="tc" style="display: flex;">By continuing I certify that I am 18 years of age, and I agree to the <a href="/legal-documents/" target="_blank">Terms and Conditions</a>, <a href="/legal-documents/" target="_blank">Privacy Policy</a>,<a href="/legal-documents/" target="_blank"> PDS</a> and <a href="/legal-documents/" target="_blank">FSG.</a></span></label>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
...
<!-- <a style="color: #515151 !important; display: inline !important;" href="/legal-documents/" target="_blank"></a> -->

<!-- <a href="/legal-documents/" target="_blank">By continuing I certify that I am 18 years of age, and I agree to the Terms and Conditions, Privacy Policy, PDS and FSG.</a> -->
