...
if ($statusCode == 200) {
      ...
      //echo "Email duplicated";
        ...
        $emailError = 'Seu período de avaliação de 30 dias expirou. Inscreva-se em uma conta ativa para acessar uma demonstração estendida de 30 dias.';
