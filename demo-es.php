...
// )
    ...
    'lead-language-id' => 50, // 1 -> English | 43 -> Portuguese | 50 -> Spanish
...
if ($statusCode == 200) {
      // successful response - continue as planned.        
        ...
        $yourURL="/es/cuenta-demo-gracias/";
      ...
      //echo "Email duplicated";
        ...
        $emailError = 'Tu período de prueba de 30 días ha expirado. Para obtener una demo adicional deberás abrir una cuenta real y realizar el depósito mínimo.';
        ...
        <input id="redirect_url" type="hidden" name="redirect_url" value="https://www.clmforex.com/demo-account-thank-you"; />                                                    
                            ...
                            <div class="col-md-6" style="padding-right: 5px;">
                                <div class="form-group">
                                    ...
                                    <input id="lead-first-name" type="text" name="lead-first-name" class="form-control" placeholder="Nombre*" required="required" data-error="Nombre is requiredo.">
                            ...
                            <div class="col-md-6" style="padding-left: 5px;">
                                <div class="form-group">
                                    ...
                                    <input id="lead-last-name" type="text" name="lead-last-name" class="form-control" placeholder="Apellido*" required="required" data-error="Apellido is requiredo.">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="lead-email" type="email" name="lead-email" class="form-control" placeholder="Correo electrónico*" required="required" data-error="Valid email is required." value="<?php if (isset($email)) echo $emailError ?>">
                                    <!-- <span class="error"><?php if (isset($emailError)) echo $emailError ?></span>  -->
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
...
/* input[type="checkbox"]:not(:disabled)+span.tyc:hover:before { text-shadow: 0 1px 2px #77F; } */
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label style="position:relative; padding-left:27px; display:block; color: #515151; display: block; font-size: 11px; font-family: avenir-regular; font-weight: 500;"><input class="abc" type="checkbox" required="required"><span class="tyc" id="tc" style="display: flex;">Al continuar yo certifico que soy mayor de 18 años y estoy de acuerdo con los <a href="/es/legal-documents/" target="_blank">términos y condiciones</a>, <a href="/es/legal-documents/" target="_blank">politica de privacidad</a>, <a href="/es/legal-documents/" target="_blank">declaración de productos</a> y <a href="/es/legal-documents/" target="_blank">guia de servicios financieros</a>.</span></label>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
  ...
  #tc a{
    ...
    display: contents !important;
                            ...
                            <div class="col-md-12">
                                ...
                                <!-- <input style="color: #fff; font-family: avenir-regular; font-weight: 500;  font-size: 17px;  border-radius: 8px !important" type="submit" name="submit" class="btn btn-success btn-send" onclick="location.href='https://clmmultisites.wpengine.com/es/live';" value="LIVE">  --> 

                                <!-- <input style="color: #fff; font-family: avenir-regular; font-weight: 500;  font-size: 17px;  border-radius: 8px !important" type="submit" name="submit" class="btn btn-success btn-send" onclick="passvalues();" formaction="https://clmmultisites.wpengine.com/es/live" value="LIVE">    -->

                                <input style="color: #fff; font-family: avenir-regular; font-weight: 500;  font-size: 17px;  border-radius: 8px !important" type="submit" name="submit" class="btn btn-success btn-send" onclick="passvalues();" formaction="/es/cuenta-real-aplicacion" value="REAL">   

                                <!-- <input type="submit" value="Click" onclick="passvalues();" formaction="https://clmmultisites.wpengine.com/es/live"/>  -->
...
<br/>
<center>
<p style="font-family: avenir-regular; font-size: 22px; font-weight: normal; color: #ffffff;"><a style="color: #ffffff !important;" href="/es/ingresa">¿Ya tienes cuenta? <u>Ingresar</u></a></p>
</center>
...
<div class="footer">
  <p style="text-align: justify; color: #ffffff; font-family: avenir-regular; font-size: 11px;">Risk Warning: Trading Forex and Derivatives carries a high level of risk to your capital and you should only trade with money you can afford to lose. You should carefully analyze whether trading is suitable for you considering your circumstances, knowledge, and financial resources. Trading Derivatives may not be suitable for all investors, please ensure that you fully understand the risks involved, and seek independent advice if necessary. A Financial Services Guide (FSG) and Product Disclosure Statements (PDS) for these products is available from CLMarkets Ltd. to download from this website. The FSG and PDS should be considered before making a decision to enter into any transactions with CLMarkets Ltd. The information on this site is not intended for residents in any country or jurisdiction where such distribution or use would be prohibited by local laws or regulation. Core Liquidity Markets is a trading name of CLMarkets Ltd. with registered address at Suite 305, Griffith Corporate Centre Beachmont, Kingston, St. Vincent and the Grenadines IBC No. 24750-IBC-2018. </p>
</div> -->
