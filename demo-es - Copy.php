...
if ($statusCode == 200) {
      ...
      //echo "Email duplicated";
        ...
        $emailError = 'Tu período de prueba de 30 días ha expirado. Regístrate para obtener una cuenta real para acceder a una demostración extendida de 30 días.';
...
/* input[type="checkbox"]:not(:disabled)+span.tyc:hover:before { text-shadow: 0 1px 2px #77F; } */
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label style="position:relative; padding-left:27px; display:block; color: #515151; display: block; font-size: 11px; font-family: avenir-regular; font-weight: 500;"><input class="abc" type="checkbox" required="required"><span class="tyc" style="display: flex;"><a style="color: #515151 !important" href="/es/legal-documents/" target="_blank">Al continuar yo certifico que soy mayor de 18 años y estoy de acuerdo con los términos y condiciones, politica de privacidad, declaración de productos y guia de servicios financieros.</a></span></label>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
